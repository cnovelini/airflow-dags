...
def test_env_var():
    variables = ['STAGE_DB_HOST_READER', 'STAGE_DB_HOST_WRITER', 'STAGE_DB_NAME', 'ODW_DB_HOST', 'ODW_DB_NAME', 'IMPORT_FINANCIAL_RAZAC_DATA_S3_AWS_ACCESS_KEY_ID', 'IMPORT_FINANCIAL_RAZAC_DATA_S3_AWS_SECRET_ACCESS_KEY', 'STAGE_DB_USERNAME', 'STAGE_DB_PASSWORD', 'ODW_AIRFLOW_PASSWORD', 'ODW_AIRFLOW_USERNAME']
    try:
